...
@section('content')
<!-- START: icons/linear-icons-free -->
<div class="card">
  <div class="card-header">
    <span class="cui-utils-title">
      <strong>Linear Icons Free</strong>
      <a href="https://linearicons.com/free" target="_blank" class="btn btn-sm btn-primary ml-2"
  ...
  <div class="card-body">
    <div class="row">
      <div class="col-xl-6 offset-xl-3">
        <ul class="cui-utils-icons-block list-unstyled">
...
<script>
  ;(function($) {
    'use strict'
    $(function() {
      $('.cui-utils-icons-block li').each(function() {
        $(this).tooltip({
          title: $(this)
            .find('i')
            .attr('class'),
