    ...
    <tbody>
      @foreach ($transaction_det as $item)
        <tr>
          ...
          <td>{{ $item->transaction->nm_transaksi }}</td>
          <td>{{ $item->nm_transaction_det }}</td>
          <td>
    ...
    $('.btnUbah').on('click',function(e){
      ...
      $.ajax({
          ...
          success: function(data) {
              ...
              $('#id').val(data.id);
              $('#transaction_id').val(data.transaction_id).trigger('change');
              $('#nm_transaction_det').val(data.nm_transaction_det);
