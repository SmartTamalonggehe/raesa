            ...
            <form class="form-horizontal" id="formKu" novalidate>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12 col-md-6">
                      <div class="form-group">
                          <div class="controls">
                              <label for="tgl_kas">Tgl. Pendapatan</label>
                              <input
                                name="tgl_kas"
                                type="text"
                                class="form-control"
                  ...
                  <div class="col-sm-12">
                      <div class="form-group">
                          <div class="controls">
                              <label for="jmlh_pemasukan">Jumlah Pendapatan</label>
                              <input type="text" name="jmlh_pemasukan" id="jmlh_pemasukan" class="form-control" required data-validation-required-message="Tidak Boleh Kosong">
                          </div>
                      </div>
                  </div>
                </div>
...
<script>
   $('#jmlh_pemasukan').mask('000.000.000.000.000', { reverse: true })
</script>
